...
public class RobotContainer {
  ...
  XboxController xboxController = new XboxController(Constants.XBOX_CONTROLLER);
  ...
  public RobotContainer() {
    ...
    colorSubsystem.setDefaultCommand(
      new RunCommand(()-> colorSubsystem.color(xboxController.getXButton()),colorSubsystem));
